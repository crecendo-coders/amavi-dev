...
Props..
1. control= checkbox - required to determine the type of form control we need to render
2. label prop = 'pick more than one option' - label text for the form field 
