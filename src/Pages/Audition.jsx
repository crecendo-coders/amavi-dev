    ...
    return (
        <div className="p-4 border border-gray-300 rounded-lg shadow-md">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <select className="p-2 mb-4 border border-gray-300 rounded" {...register("title", { required: true })}>
                ...
                <label className="block mb-2 text-black">How did you hear about us?</label>
                <select className="p-2 mb-4 border border-gray-300 rounded" {...register("connection")}>
                ...
                <select className="p-2 mb-4 border border-gray-300 rounded" {...register("voicingId")}>
                    <option value="select">Select...</option>
                ...
                <div className="p-4">
                    <div className="g-recaptcha" data-sitekey={import.meta.env.VITE_PUBLIC_CAPTCHA}></div>
                </div>
